...
pub use types::{
    ...
    ComputeStorageImageResource, ComputeStorageResidency, ComputeTextureShape, DepthState,
    DrawError, DrawOutput, DrawRequest, GuestRun, GuestRunSource, GuestSampledBacking,
